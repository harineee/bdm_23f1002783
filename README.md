...
**Pricing:** Annual revenue leakage of ₹1.56L from inconsistent discounting. Wholesale customers average 11.6% discounts (max 17.9%) against a recommended cap of 12%. Standardized discount slabs by customer type are proposed.
...
│       ├── generate_additional_charts.py    Extended visualisations (charts 10–24)
